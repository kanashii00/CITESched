...
--
-- Class AiChatSession as table chat_sessions
--
...
CREATE INDEX "chat_sessions_user_role_updated_idx" ON "chat_sessions" USING btree ("userId", "roleType", "updatedAt");

--
-- Class AiChatMessage as table chat_messages
--
...
CREATE INDEX "chat_messages_session_timestamp_idx" ON "chat_messages" USING btree ("sessionRecordId", "timestamp");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('citesched', '20260430060000000', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260430060000000', "timestamp" = now();
